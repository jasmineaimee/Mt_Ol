public class Persephone : Character
{
    protected override void Start()
    {
        base.Start();
        if(InventoryManager.Instance.isInInventory(Collectables.Flowers))
        {
            missionActive = true;
        }
        missionStatement = "Welcome Philotes. I need you to make sure my boxes are lighting in the correct order, and then I can give you the Flower Zeus wanted. Just Press A on the spot by the chest to start!";
